  ...
  // Step 1 — Learn Rules
  {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: "📊",
        headingZh: "9 大统计类别",
        headingEn: "9 Scoring Categories",
        items: [
          { zh: "得分（PTS）— 每次投篮得分计入", en: "Points (PTS) — every basket counts" },
          { zh: "篮板（REB）— 进攻 + 防守篮板合计", en: "Rebounds (REB) — offensive + defensive combined" },
          { zh: "助攻（AST）— 直接导致队友得分", en: "Assists (AST) — direct pass leading to a basket" },
          { zh: "抢断（STL）— 防守端截断传球或运球", en: "Steals (STL) — deflecting a pass or dribble on defense" },
          { zh: "盖帽（BLK）— 封盖对手投篮", en: "Blocks (BLK) — rejecting an opponent's shot" },
          { zh: "三分球（3PM）— 三分线外命中数", en: "3-Pointers Made (3PM) — shots made beyond the arc" },
          { zh: "投篮命中率（FG%）— 衡量效率，不是绝对数量", en: "Field Goal % (FG%) — measures efficiency, not raw makes" },
          { zh: "罚球命中率（FT%）— 罚球线上的精准度", en: "Free Throw % (FT%) — accuracy at the charity stripe" },
          { zh: "失误（TOV）— 此类别越少越好（负分项）", en: "Turnovers (TOV) — fewer is better; this category counts against you" },
        ],
      },
      {
        iconBg: "#dcfce7",
        icon: "⚔️",
        headingZh: "对决制规则",
        headingEn: "Head-to-Head Matchups",
        items: [
          { zh: "每周你与对手在 9 个类别中分别比较", en: "Each week you and your opponent compare totals across all 9 categories" },
          { zh: "赢得更多类别即胜利（例如 6-3 或 5-4）", en: "Win more categories to win the matchup (e.g. 6-3 or 5-4)" },
          { zh: "每次类别胜利都计入你的赛季胜负记录", en: "Each category win contributes to your season win-loss record" },
          { zh: "常规赛结束后，成绩最好的球队进入季后赛", en: "After the regular season, top teams advance to the playoffs" },
        ],
      },
    ],
  },
  ...
  // Step 4 — Manage Team
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { zh: "自由球员市场（Waiver Wire）是赛季中补强球队的最佳途径", en: "The waiver wire is your best tool for upgrading your roster mid-season" },
          { zh: "当球员因伤缺阵或表现不佳时，果断弃牌补充新力量", en: "Drop underperformers or injured players and pick up emerging talent" },
