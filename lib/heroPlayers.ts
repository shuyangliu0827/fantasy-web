...
export const HERO_PLAYERS: HeroPlayer[] = [
  {
    id: "lebron", name: "LeBron James", nameZh: "勒布朗·詹姆斯",
  ...
  {
    id: "jokic", name: "Nikola Jokić", nameZh: "尼古拉·约基奇",
  ...
  {
    id: "curry", name: "Stephen Curry", nameZh: "斯蒂芬·库里",
  ...
  {
    id: "giannis", name: "Giannis Antetokounmpo", nameZh: "扬尼斯·字母哥",
  ...
  {
    id: "luka", name: "Luka Dončić", nameZh: "卢卡·东契奇",
  ...
  {
    id: "shai", name: "Shai Gilgeous-Alexander", nameZh: "亚历山大",
  ...
  {
    id: "tatum", name: "Jayson Tatum", nameZh: "杰森·塔图姆",
  ...
  {
    id: "embiid", name: "Joel Embiid", nameZh: "乔尔·恩比德",
  ...
  {
    id: "durant", name: "Kevin Durant", nameZh: "凯文·杜兰特",
  ...
  {
    id: "ad", name: "Anthony Davis", nameZh: "安东尼·戴维斯",
  ...
  {
    id: "ant", name: "Anthony Edwards", nameZh: "安东尼·爱德华兹",
  ...
  {
    id: "wemby", name: "Victor Wembanyama", nameZh: "文班亚马",
  ...
  {
    id: "lamelo", name: "LaMelo Ball", nameZh: "拉梅洛·鲍尔",
  ...
  {
    id: "paolo", name: "Paolo Banchero", nameZh: "保罗·班凯罗",
  ...
  {
    id: "dame", name: "Damian Lillard", nameZh: "达米安·利拉德",
  ...
  {
    id: "booker", name: "Devin Booker", nameZh: "德文·布克",
  ...
  {
    id: "brunson", name: "Jalen Brunson", nameZh: "杰伦·布伦森",
  ...
  {
    id: "fox", name: "De'Aaron Fox", nameZh: "福克斯",
  ...
  {
    id: "morant", name: "Ja Morant", nameZh: "贾·莫兰特",
  ...
  {
    id: "mitchell", name: "Donovan Mitchell", nameZh: "多诺万·米切尔",
  ...
  {
    id: "tyrese", name: "Tyrese Haliburton", nameZh: "泰里斯·哈利伯顿",
